                ...
                <form action="{{url('/adduser')}}" method="post">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="female" type="radio" class="@error('gender') is-invalid @enderror" name="gender" value="FeMale" required autofocus> <p>FeMale</p>
                                <br>
                                <input id="male" type="radio" class="@error('gender') is-invalid @enderror" name="gender" value="Male" required autofocus><p> Male</p>
